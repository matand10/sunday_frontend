            ...
            <div className="group-header-wrapper">
                ...
                {group.tasks.map((task, idx) => {
                    return <TasksList key={idx} task={task} menuRef={menuRef} backgroundColor={group.style.color}
                        onHandleRightClick={onHandleRightClick} onOpenMenu={onOpenMenu} group={group} board={board} removeTask={removeTask} onOpenModal={onOpenModal} updateTask={updateTask} />
